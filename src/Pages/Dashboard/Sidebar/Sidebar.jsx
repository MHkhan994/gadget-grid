...
const Sidebar = () => {
    return (
        <div className="sidebar h-screen w-56 overflow-y-auto border-r shadow-xl">
            <div className="h-full py-10">
                <div className='pb-10 flex justify-center'>
                    <img src="./logo.png" className='h-10' alt="" />
                </div>
                <div className='flex flex-col gap-2 text-lg ps-3'>
                    <NavLink to={'/dashboard/orders'} className={(isActive) => isActive ? 'bg-gradient links text-white rounded-s-full' : 'links'}>
